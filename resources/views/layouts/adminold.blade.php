...
<span class="float-right text-muted text-sm">2 days</span>
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    <!-- Brand Logo -->
    <a href="http://www.servicedesk-ctsn.com">
      <img src="{{ asset('dist/img/AdminLTELogo.png') }}" alt="AdminLTE Logo" class="brand-image img-circle elevation-3"
           style="opacity: .8">
      <span class="brand-text ">Aller sur GLPI</span>
    </a>
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="{{ url('/customer/') }}" class="nav-link ">
                  ...
                  <p>Clients & Contrats </p>
                </a>
              </li>
                <li class="nav-item">
                    <a href="{{ url('/mps/') }}" class="nav-link ">
                        <i class="fa fa-circle-o nav-icon"></i>
                        <p>MPS</p>
                    </a>
                </li>
...
Extras
          ...
          <li class="nav-item">
            <a href="{{ url('/taxi/') }}" class="nav-link">
  ...
  <footer class="main-footer">
    <strong>Copyright Elvis T. &copy; 2019 All rights reserved <!--<a href="http://www.servicedesk-ctsn.com">GLPI</a>-->.</strong>

    <div class="float-right d-none d-sm-inline-block">
      <b><a href="http://www.servicedesk-ctsn.com">Se rendre sur GLPI</a></b>
</div>
  </footer>
